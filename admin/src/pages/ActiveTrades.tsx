...
export default function AdminActiveTrades() {
  ...
  useEffect(() => {
    ...
    // Also load portfolioStocks collection
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isPortfolio) {
        ...
        if (pdfFile) {
          // Store file name for now — Firebase Storage upload requires storage config
      ...
      if (editId) {
        ...
        // Portfolio stocks go to portfolioStocks collection
        const targetCollection = isPortfolio ? 'portfolioStocks' : 'activeTrades';
      ...
      <Dialog open={modalOpen} onClose={handleCloseModal} maxWidth="sm" fullWidth>
        ...
        <Box component="form" onSubmit={handleSubmit}>
          <DialogContent sx={{ pt: 1 }}>
            ...
            {/* SEGMENT — now includes Portfolio */}
