  ...
  return (
    <ScrollView style={s.scroll} contentContainerStyle={s.content}>
      ...
      <View style={s.overallCard}>
        ...
        <DonutGauge accuracy={overall.accuracy} size={85} strokeWidth={10} fillColor="#3b82f6" />
        <View style={s.row}>
          <View style={s.stat}>
...
const s = StyleSheet.create({
  ...
  content: { padding: 8, paddingBottom: 8, alignItems: 'center', gap: 6 },
  overallCard: {
    backgroundColor: '#fff', borderRadius: 18, padding: 8, alignItems: 'center',
  ...
  quickIconBox: {
    width: 34, height: 34, borderRadius: 9, backgroundColor: '#f1f5f9',
  ...
  subCard: {
    width: '100%', backgroundColor: '#fff', borderRadius: 16, padding: 10,
