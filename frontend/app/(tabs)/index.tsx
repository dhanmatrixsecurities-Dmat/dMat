  ...
  return (
    <ScrollView style={s.scroll} contentContainerStyle={s.content}>
      ...
      <View style={s.overallCard}>
        ...
        <DonutGauge accuracy={overall.accuracy} size={100} strokeWidth={11} fillColor="#3b82f6" />
        <View style={s.row}>
          <View style={s.stat}>
...
const s = StyleSheet.create({
  ...
  content: { padding: 10, paddingBottom: 12, alignItems: 'center', gap: 8 },
  overallCard: {
    backgroundColor: '#fff', borderRadius: 18, padding: 10, alignItems: 'center',
    width: '100%', elevation: 4,
    shadowColor: '#000', shadowOpacity: 0.08, shadowRadius: 12, shadowOffset: { width: 0, height: 4 },
  },
  heading: { fontSize: 14, fontWeight: '800', color: '#1e3a5f', marginBottom: 6 },
  row: {
