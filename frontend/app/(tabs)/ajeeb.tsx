    ...
    <Animated.View
      style={[
        logo.eye,
        {
          ...
          shadowColor: '#2979FF', shadowOpacity: 0.6,
...
const logo = StyleSheet.create({
  ...
  letter: {
    fontWeight: '900', color: '#2979FF',
    fontFamily: Platform.OS === 'ios' ? 'Courier New' : 'monospace',
    textShadowColor: '#2979FF', textShadowOffset: { width: 0, height: 0 }, textShadowRadius: 8,
  },
  eye: {
    borderWidth: 2, backgroundColor: '#0D2247',
...
export default function KookyScreen() {
  ...
  return (
    // SafeAreaView with edges={['top']} — fixes status bar overlap on AI page
    <SafeAreaView style={{ flex: 1, backgroundColor: Colors.background }} edges={['top']}>
      <KeyboardAvoidingView
        style={{ flex: 1 }}
      ...
      >
        {/* KookyLogo header — no longer bleeds into status bar */}
...
const styles = StyleSheet.create({
  topHeader: {
    ...
    backgroundColor: '#0B1A2E', paddingHorizontal: 16, paddingVertical: 12,
    borderBottomWidth: 1, borderBottomColor: '#173772',
  },
  agentBadge: {
  ...
  portfolioTopBtn: {
    ...
    borderRadius: 20, borderWidth: 1.5, borderColor: '#2979FF',
  },
