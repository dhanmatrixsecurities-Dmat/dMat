  ...
  return (
    <SafeAreaView style={styles.container}>
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.keyboardView}>
        ...
        {/* ── MAIN LAYOUT: 3 sections filling full screen ── */}
        <View style={styles.layout}>

          {/* SECTION 1: Brand + Headline */}
              ...
              <View>
                <View style={styles.inputContainer}>
                  ...
                  <TextInput style={styles.input} placeholder="Enter your full name"
                    placeholderTextColor="rgba(255,255,255,0.25)" value={name} onChangeText={setName} autoCapitalize="words" />
                </View>
                <View style={styles.inputContainer}>
                  <Text style={styles.label}>Mobile Number</Text>
                  <View style={styles.mobileRow}>
                    <View style={styles.countryCode}><Text style={styles.countryCodeText}>🇮🇳 +91</Text></View>
                    <TextInput style={[styles.input, styles.mobileInput]} placeholder="9XXXXXXXXX"
                      placeholderTextColor="rgba(255,255,255,0.25)" value={mobile} onChangeText={setMobile}
                ...
                <View style={styles.inputContainer}>
                  <Text style={styles.label}>Password</Text>
                  <View style={styles.passRow}>
                    <TextInput style={[styles.input, { flex: 1, paddingRight: 48 }]} placeholder="Min. 6 characters"
                      placeholderTextColor="rgba(255,255,255,0.25)" value={regPassword} onChangeText={setRegPassword} secureTextEntry={!showPass} />
                    <TouchableOpacity onPress={() => setShowPass(!showPass)} style={styles.eyeBtn}>
                      <Ionicons name={showPass ? 'eye-off-outline' : 'eye-outline'} size={22} color="rgba(255,255,255,0.4)" />
                    </TouchableOpacity>
                  </View>
                ...
                <View style={styles.inputContainer}>
                  ...
                  <View style={styles.passRow}>
                    <TextInput style={[styles.input, { flex: 1, paddingRight: 48 }]} placeholder="Re-enter password"
                      placeholderTextColor="rgba(255,255,255,0.25)" value={confirmPassword} onChangeText={setConfirmPassword} secureTextEntry={!showConfirmPass} />
...
const styles = StyleSheet.create({
  ...
  keyboardView: { flex: 1 },
  layout: { flex: 1, paddingHorizontal: 24, paddingTop: 16, paddingBottom: 24, justifyContent: 'space-between' },

  topSection: {},
  brandRow: { flexDirection: 'row', alignItems: 'center', gap: 10, marginBottom: 24 },
  logoWrap: { width: 38, height: 38, borderRadius: 10, backgroundColor: '#132044', overflow: 'hidden' },
  ...
  headlineLine2Row: { flexDirection: 'row', alignItems: 'flex-end', marginBottom: 8 },
  ...
  middleSection: {},
  toggleRow: { flexDirection: 'row', backgroundColor: 'rgba(255,255,255,0.05)', borderRadius: 12, padding: 4, marginBottom: 16, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)' },
  ...
  mobileInput: { flex: 1 },
  infoNote: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: 'rgba(59,130,246,0.1)', borderRadius: 10, padding: 10, marginBottom: 12, borderWidth: 1, borderColor: 'rgba(59,130,246,0.2)' },
