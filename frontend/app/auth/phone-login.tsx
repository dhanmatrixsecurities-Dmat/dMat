...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 32, fontWeight: 'bold', color: '#ffffff', marginTop: 12 },
  subtitle: { fontSize: 15, color: 'rgba(255,255,255,0.4)', marginTop: 6, textAlign: 'center' },
  toggleRow: { flexDirection: 'row', backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 12, padding: 4, marginBottom: 24, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)' },
  ...
  label: { fontSize: 13, fontWeight: '700', color: 'rgba(255,255,255,0.5)', marginBottom: 7, letterSpacing: 0.5, textTransform: 'uppercase' },
  input: {
  ...
  mobileInput: { flex: 1 },
  infoNote: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: 'rgba(59,130,246,0.12)', borderRadius: 10, padding: 10, marginBottom: 16, borderWidth: 1, borderColor: 'rgba(59,130,246,0.2)' },
  ...
  buttonDisabled: { backgroundColor: 'rgba(255,255,255,0.1)', elevation: 0, shadowOpacity: 0 },
